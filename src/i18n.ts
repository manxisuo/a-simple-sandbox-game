...
const en = {
  ...
  'settings.weatherAuto': 'Automatic cycle',
  'settings.weatherClear': 'Clear',
  'settings.weatherDrizzle': 'Drizzle',
  'settings.weatherRain': 'Rain',
  'settings.weatherStorm': 'Thunderstorm',
  'settings.weatherMist': 'Mist',
  'settings.weatherSnow': 'Snow',
  'settings.terrain': 'Terrain',
  'settings.camera': 'Camera',
  'settings.visual': 'Visual',
  'settings.audio': 'Audio',
  'settings.audioMute': 'Mute all audio',
  'settings.audioMaster': 'Master volume',
  'settings.audioAmbient': 'Ambient volume',
  'settings.audioEffects': 'Effects volume',
  ...
  'message.weatherClear': 'The weather clears and the air opens up again.',
  'message.weatherDrizzle': 'A light drizzle begins to fall.',
  'message.weatherRain': 'Steady rain settles over the landscape.',
  'message.weatherStorm': 'Dark weather gathers. Rain intensifies and thunder rolls nearby.',
  'message.weatherMist': 'A low mist drifts across the ground.',
  'message.weatherSnow': 'Snow begins to drift down in broad, quiet flakes.',
...
const zh: Record<TranslationKey, string> = {
  ...
  'settings.time': '时间',
  'settings.weather': '天气',
  'settings.weatherMode': '天气模式',
  'settings.weatherAuto': '自动切换',
  'settings.weatherClear': '晴朗',
  'settings.weatherDrizzle': '细雨',
  'settings.weatherRain': '中雨',
  'settings.weatherStorm': '雷雨',
  'settings.weatherMist': '薄雾',
  'settings.weatherSnow': '下雪',
  'settings.terrain': '地形',
  'settings.camera': '镜头',
  'settings.visual': '画面',
  'settings.audio': '音频',
  'settings.audioMute': '静音',
  'settings.audioMaster': '主音量',
  'settings.audioAmbient': '环境音量',
  'settings.audioEffects': '音效音量',
  ...
  'message.weatherClear': '天气渐渐放晴，空气重新开阔起来。',
  'message.weatherDrizzle': '细密的小雨开始落下。',
  'message.weatherRain': '稳定的雨幕笼罩了这片土地。',
  'message.weatherStorm': '天气迅速转坏。雨势增强，附近开始传来雷声。',
  'message.weatherMist': '低矮的雾气开始贴着地面缓缓流动。',
  'message.weatherSnow': '雪花开始安静地飘落下来。',
